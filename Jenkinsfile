    ...
    stages {
        ...
        stage('Build and Deploy FastAPI Backend') {
            steps {
              ...
              // sh "sudo pm2 start 'gunicorn /home.dcnc.salesaccount.web.Backend.main:app --workers 4 --worker-class uvicorn.workers.UvicornWorker --bind  0.0.0.0:55502 --timeout=3000' --name reconcileaibackend"
            }
        }
    }
}
