	...
	<div>
		...
		<div className="p-5 md:p-10 mx-auto">
			...
			<p className=" mt-5 text-black1 xl:mx-auto ">
				...
				increased transparency and control of your customers&rsquo; data, all
				while harnessing the power of that data to connect with customers in new
				ways.
			</p>
			<div className="md:flex justify-between xl:w-9/12  xl:mx-auto ">
				...
				<div className="">
					...
					<p className=" mt-5 w-72 sm:text-center sm:w-full">
						We safeguard our customers&rsquo; data with a robust, comprehensive,
						and transparent privacy and security program.
					</p>
				</div>
			</div>
