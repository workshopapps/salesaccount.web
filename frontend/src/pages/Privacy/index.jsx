...
import photo1 from '../../assets/images/Privacy/photo1.png';
...
const Privacy = () => (
	<div>
		<Navbar />
		<div className="p-4 md:p-10 lg:p-x20 xl:px-36 2xl:px-40 mx-auto">
			<div className="">
				<div className="bg-[#F2F4F7] w-full md:flex md:flex-row md:gap-10 lg:py-20 lg:px-36">
					<div className="">
						<h2 className=" text-xl font-semibold  md:w-3/4 xl:mx-auto   ">
							Turn data privacy into an opportunity to enhance customer
							experiences
						</h2>
						<p className="my-4 text-sm xl:mx-auto ">
				...
				<div className="bg-[#F2F4F7] md:bg-none w-full md:flex md:flex-row md:gap-10 lg:py-20 lg:px-36">
					<div className="">
						<h2 className="mt-10 text-xl font-semibold  xl:text-center">
							Privacy for every customer
						</h2>
						<p className="my-4 w-full text-sm sm:text-center sm:w-full">
				...
				<div className="bg-[#F2F4F7] w-full md:flex md:flex-row md:gap-10 lg:py-20 lg:px-36">
					<div className="">
						<h2 className="mt-10 text-xl font-semibold xl:text-center sm:mx-auto sm:text-center ">
			...
			<h2 className="my-10 text-center text-xl md:text-xl lg:text-[3rem] leading-[50px] font-semibold">
				We have five privacy principles that highlight our commitment to trust.
			</h2>
			<div className="bg-[#F9FAFB] md:bg-none md:grid gap-20 grid-cols-2">
				<div className="md:bg-[#F9FAFB] px-6 py-12">
					<div className="">
						<img className="  w-68 mx-auto " src={padlock} alt="padlock" />
				...
				<div className="md:bg-[#F9FAFB] px-6 py-12">
					<div className="">
						<img className=" w-68 mx-auto" src={Key} alt="key" />
				...
				<div className="md:bg-[#F9FAFB] px-6 py-12">
					<div className="">
						<img className="w-68 mx-auto" src={Camera} alt="camera" />
						<p className=" text-blue-600 text-center font-bold text-2xl pt-0">
							Transparency
						</p>
					</div>
				...
				<div className="md:bg-[#F9FAFB] px-6 py-12">
					<div className="">
						<img className=" w-68 mx-auto" src={Globe} alt="globe" />
						<p className="text-blue-600 text-center font-bold text-2xl pt-0">
							Compliance
						</p>
					</div>
