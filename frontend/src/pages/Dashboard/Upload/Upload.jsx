...
function Upload() {
	...
	// ContextApi
	const { fileDropped, fileDropped2, setFileDropped, setFileDropped2 } =
		useAuth();

	// Jsx
	return (
		<div className="w-full h-max flex flex-col justify-center items-center  text-center space-y-4 mt-[3em] md:mt-[5em]">
			{/* Upload Account Statement  */}
			<div className="w-full mb-[1em] space-y-2 justify-center items-center flex flex-col">
				{fileDropped.name ? (
					<div className="flex justify-between items-center py-[1.5em] px-[1em] w-full md:w-[80%] lg:w-[40%] my-2 text-[#475467] text-sm md:text-md text-left border border-[#667085] rounded-sm">
						{/* Upload SuccessFul */}
					...
					<div
						...
						role="presentation"
						className="py-[1.5em] px-[2em] w-full md:w-[80%] lg:w-[40%] my-2 bg-[#F9FAFB] text-[#2E90FA] text-sm md:text-base lg:text-lg  font-semibold border border-[#2E90FA]  rounded-sm active:bg-[#e4e8ec]"
					>
				...
				{fileDropped2.name ? (
					...
					>
						<div className="py-[1.5em] px-[2em] w-full md:w-[80%] lg:w-[40%] my-2 bg-[#F9FAFB] text-[#2E90FA] text-sm md:text-base lg:text-lg  font-semibold border border-[#2E90FA]  rounded-sm active:bg-[#e4e8ec]">
			...
			<div className="text-[#667085] text-xs md:text-sm w-full space-y-1">
				...
				<p>
					Uploaded files should contain: Date, Description & Credit/Debit Scores
				</p>
			</div>
