...
const UploadedAccountStatementReady = () => {
  ...
  return (
	<div>
		{/* Nav and sidebar components should be here */}
		<div className='m-8 '>
			...
			<div className="flex justify-between w-full mt-5">
					<div className="flex items-center">
						<label htmlFor="display" className="mr-2 text-base font-medium text-gray-700 font-Lexend">
							Display
						</label>
						<select
							name=""
							id="display"
							className=" border border-[#939393] rounded-xl p-2 w-80 h-9 mr-2 text-base font-medium text-gray-700 font-Lexend">
					...
					<div >
						...
						<select
							name=""
							id=""
							className=" border border-[#939393] justify-center p-2 pb-0 w-48 h-9 mr-2 text-base font-medium text-gray-700 font-Lexend overflow-hidden rounded-xl"
						>
				...
				<table className="w-full bg-gray-300 table-auto rounded-xl" > 
					<thead>
						<tr className='w-full '>
					...
					<tbody>
						{ contacts.map(( c )=> (
								<tr className='border-b border-b-gray-700 border-opacity-20 '>
									<td className= 'py-6 pl-4 text-sm font-normal leading-5 text-left border-spacing-2 w-80 font-Lexend'>{contacts.Name}</td>
									<td className= 'py-6 pl-4 text-sm font-normal leading-5 text-left border-b-gray-700 border-spacing-2 w-80 font-Lexend'>{contacts.Description}</td>
									<td className= 'py-6 pl-4 text-sm font-normal leading-5 text-left border-b-gray-700 border-spacing-2 w-80 font-Lexend text-withdraw'>{contacts.Withdrawals}</td>
									<td className= 'py-6 pl-4 text-sm font-normal leading-5 text-left border-b-gray-700 border-spacing-2 w-80 font-Lexend text-deposit'>{contacts.Deposits}</td>
									<td className= 'py-6 pl-4 text-sm font-normal leading-5 text-left border-b-gray-700 border-spacing-2 w-80 font-Lexend'>{contacts.Date}</td>
									<td className= 'py-6 pl-4 text-sm font-normal leading-5 text-left border-b-gray-700 border-spacing-2 w-80 font-Lexend'>{contacts.Balance}</td>
								</tr>
							)
						)}
