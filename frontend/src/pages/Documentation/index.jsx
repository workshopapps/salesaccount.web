...
const Documentation = () => (
	<div className="text-gray-800 bg-white ">
		...
		<div className="flex flex-row min-h-screen lg:grid  md:grid-cols-[15rem_7fr]  sm:grid-cols-[1fr] ">
			...
			<main className="main flex flex-col flex-grow mx-auto md:ml-0 md:p-[3rem] transition-all duration-150 ease-in h-[100vh] overflow-scroll">
				...
				<div className="flex flex-col flex-grow p-2 md:p-4 main-content">
					<div className="flex flex-col flex-grow mt-4 rounded">
						...
						<section className="mb-11" id='howToUse'>
							...
							<img className=' mx-[35vw] mb-5 md:hidden' src ={steponeMobile} alt= ' '/>
							</picture>
							...
							<img className='mx-[35vw] mb-5 md:hidden' src ={steptwoMobile} alt= ' '/>
							</picture>
							...
							<img className='  mx-[35vw] mb-5 md:hidden' src ={stepthreeMobile} alt= ' '/>
							</picture>
