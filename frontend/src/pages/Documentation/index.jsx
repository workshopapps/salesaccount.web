...
const Documentation = () => (
	<div className="text-gray-800 bg-white ">
		...
		<div className="flex flex-row min-h-screen">
			...
			<main className="flex flex-col flex-grow transition-all duration-150 ease-in main -ml-14 md:ml-0">
              ...
              <p className='mb-5'><span className='font-bold'>Businesses: </span>
                ...
                <p className='mb-5'><span className='font-bold'> Accountants:</span>
						...
						<section className="mb-11">
							<h1 className="mb-4 text-2xl font-bold"> How to use Recon</h1>
							<p className='mb-6'>
              ...
              <img className='mb-5' src={stepThree} alt= ' ' />
						...
						<section>
							...
							<h2 className='mb-4 font-bold' >Key Values Recon offers.</h2>
