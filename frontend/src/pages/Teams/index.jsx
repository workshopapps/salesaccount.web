		...
		<div className="px-[44px] xl:px-[72px] mt-8">
			<div className="lg:flex lg:flex-row md:flex md:flex-row  flex-col  grid justify-items-center">
				<div className="font-lexend lg:mt-24 md:mt-24">
					<button type='button' className="rounded-lg lg:ml-2 ml-16 md:ml-2 text-white bg-blue-500 text-lg px-4 py-2">
						Meet the team
					</button>
					<h2 className="lg:text-5xl text-2xl font-semibold mt-4 lg:text-left md:text-left text-center">
						...
						hard to
						<br className="hidden lg:block" /> empower our <br className="lg:hidden" />
						teams.
					</h2>
				</div>
				<div>
					<img alt='' src={ourteam} className="ml-24 hidden lg:block md:block md:ml-8" />
				</div>
			</div>
            ...
            <img alt='' src={tw} />
				...
				<div className="lg:flex lg:flex-row grid grid-cols-2 lg:gap-36 mt-12 gap-2">
					<div className="flex flex-col items-center">
						...
						<h4 className="text-blue-400 font-normal text-sm">Design PM Lead</h4>
						<div className="mt-4 flex flex-row gap-6">
            <img alt='' src={tw} />
							<img alt='' src={ln} />
							<img alt='' src={fb} />
					...
					<div className="flex flex-col items-center">
						...
						<h4 className="text-blue-400 font-normal text-sm">Frontend PM Lead</h4>
						<div className="mt-4 flex flex-row gap-6">
            <img alt='' src={tw} />
							<img alt='' src={ln} />
							<img alt='' src={fb} />
            ...
            <img alt='' src={tw} />
				...
				<div className="lg:flex lg:flex-row grid grid-cols-2 lg:gap-36 mt-12 gap-2">
					<div className="flex flex-col items-center">
						...
						<h4 className="text-blue-400 font-normal text-sm">Design Track Lead</h4>
						<div className="mt-4 flex flex-row gap-6">
            <img alt='' src={tw} />
							<img alt='' src={ln} />
							<img alt='' src={fb} />
