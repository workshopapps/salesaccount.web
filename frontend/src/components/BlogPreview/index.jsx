  ...
  return (
    <Link to="/blog/slug">
      <div className="px-6 pt-6 pb-8 shadow-[0px_12px_16px_-4px_rgba(16,24,40,0.08),0px_4px_6px_-2px_rgba(16,24,40,0.03)] bg-[#FFFFFF]">
        <div>
          <figure>
            <img className="w-full" src="../assets/images/blog/pexels1.svg" alt="" />
          </figure>
          <div className="flex flex-col gap-3 mt-8">
            ...
            <div className=" flex justify-between items-start">
              <h4 className=" text-xl leading-snug font-semibold text-[#101828]">
                ...
                <img className="w-6 h-6" src="../assets/images/blog/arrow.svg" alt="arrow" />
          ...
          <div className="flex gap-3 mt-[34px]">
            <figure className=" w-10 h-10 ">
              <img className=" rounded-full w-full" src="../assets/images/blog/avatar-full.svg" alt="" />
            </figure>
            <div>
