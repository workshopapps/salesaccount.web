...
export function Footer() {
	return (
		<footer className=" bg-[#D1E9FF] w-full text-gray-700  p-4 sm:p-6 lg:p-[4em]  ">
			<div className="md:flex md:justify-between xl:max-w-[1366px] 2xl:max-w-[1500px] mx-auto">
				<div className="flex flex-col mb-6 md:mb-0 text-black ">
					...
					<div className="my-[1em] text-gray-700 md:w-[70%]">
				...
				<div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 lg:w-[70%]">
					<div>
						<h2 className="mb-6 text-xl text-gray-700 font-semibold text-gray-900  ">
							About Us
						</h2>
						<ul>
							<li className="mb-4">
			...
			<div className="sm:flex sm:items-center sm:justify-between xl:max-w-[1366px] 2xl:max-w-[1500px] mx-auto">
