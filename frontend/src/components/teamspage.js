	...
	return (
		<div>
			<div class="flex lg:flex-row md:flex-row  flex-col">
				<div>
					<button class="rounded border  text-white bg-blue-700 font-normal px-4 py-2">
						Meet the team
					</button>
					<h2 class=" sm:hidden lg:block ">
			...
			<div>
				<div>
					<button class="rounded border  text-black bg-white font-normal px-4 py-2">
						LEADERS
					</button>
					<div class="mt-2">
