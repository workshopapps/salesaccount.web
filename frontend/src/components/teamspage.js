...
const teamspage = () => (
		<div>
			<div className="flex lg:flex-row md:flex-row  flex-col">
				<div>
					<button className="rounded border  text-white bg-blue-700 font-normal px-4 py-2" type="button">
						Meet the team
					</button>
			...
			<div>
				<div>
					<button className="rounded border  text-black bg-white font-normal px-4 py-2" type="button">
						LEADERS
					</button>
					<div className="mt-2">
