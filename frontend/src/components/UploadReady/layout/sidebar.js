		...
		>
			<ul className="text-[#FFFFFF]">
				<li className="w-full flex py-3 px-4 items-center cursor-pointer rounded-[10px] hover:bg-[#F9FAFB] hover:text-[#175CD3] mb-2">
					<span className="mr-3 text-2xl material-icons-outlined">window</span>
					Dashboard
				</li>
				<li className="w-full flex py-3 px-4 items-center cursor-pointer rounded-[10px] hover:bg-[#F9FAFB] hover:text-[#175CD3] mb-2">
					<span className="mr-3 text-2xl material-icons-outlined">add_box</span>
					Import Data
				</li>
				<li className="w-full flex py-3 px-4 items-center cursor-pointer rounded-[10px] hover:bg-[#F9FAFB] hover:text-[#175CD3] mb-2">
					<span className="mr-3 text-2xl material-icons-outlined">
						star_outline
					</span>
					History
				</li>
			...
			<ul className="text-[#FFFFFF]">
				<li className="w-full flex py-3 px-4 items-center cursor-pointer rounded-[10px] hover:bg-[#F9FAFB] hover:text-[#175CD3] mb-2">
					<span className="mr-3 text-2xl material-icons-outlined">person</span>
					<p>Privacy</p>
				</li>
				<li className="w-full flex py-3 px-4 items-center cursor-pointer rounded-[10px] hover:bg-[#F9FAFB] hover:text-[#175CD3] mb-2">
					<span className="mr-3 text-2xl material-icons-outlined">
